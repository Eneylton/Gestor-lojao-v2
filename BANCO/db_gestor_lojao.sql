...
--
-- Host: 127.0.0.1
-- Tempo de geração: 07-Abr-2021 às 14:28
...
INSERT INTO `clientes` (`id`, `nome`, `telefone`, `email`, `placa`, `veiculo_id`, `usuarios_id`) VALUES
(1, 'Eneylton Barros ', '98 991581962', 'eneylton@hotmail.com', 'NHO-5566', 1, 13),
(2, 'Margarete pineheiro', '98991581962', 'eneylton@hotmail.com', 'NHO-8596', 2, 4);
...
(34, '7891579353603    ', 0, 'AMORTECEDOR DT HONDA FIT / GP35943M', 0, '6.00', '15.98', 1, NULL, 'imgs/sem.jpg', '2021-03-18 22:45:38', 0, 8),
(35, '7891579235923    ', 0, 'AMORTECEDOR DT LD COLBAT / GP30520', 0, '6.00', '8.00', 61, NULL, 'imgs/sem.jpg', '2021-03-18 22:45:38', 0, 8),
(36, '7891579354655    ', 0, 'AMORTECEDOR DT LD COROLLA 2008 / GP32497M', 0, '6.00', '8.00', 1, NULL, 'imgs/sem.jpg', '2021-03-18 22:45:38', 0, 8),
(37, '7899027350242    ', 0, 'AMORTECEDOR DT LD MARCH', 0, '6.00', '8.00', 81, NULL, 'imgs/sem.jpg', '2021-03-18 22:45:38', 0, 8),
(38, '52093285    ', 0, 'AMORTECEDOR DT LD NEW FIESTA SEM BARRA / SP066', 0, '6.00', '8.00', 1, NULL, 'imgs/sem.jpg', '2021-03-18 22:45:38', 0, 8),
(39, '7891579297457    ', 771134, 'AMORTECEDOR DT LD ONIX / 52093285 GM', 0, '6.00', '8.00', 1, NULL, 'imgs/sem.jpg', '2021-03-18 22:45:38', 0, 8),
(40, '', 0, 'AMORTECEDOR DT LD PEUGEOT 207 / GP32688', 0, '6.00', '8.00', 1, NULL, 'imgs/sem.jpg', '2021-03-18 22:45:38', 0, 8),
(41, '7891579353610    ', 0, 'AMORTECEDOR DT LD PEUGEOUT 307', 0, '6.00', '8.00', 1, NULL, 'imgs/sem.jpg', '2021-03-18 22:45:38', 0, 8),
(42, '7891579235930    ', 771020, 'AMORTECEDOR DT LE COLBALT / GP30521', 0, '6.00', '8.00', 1, NULL, 'imgs/sem.jpg', '2021-03-18 22:45:38', 0, 8),
...
(160, '', 771669, 'BANDEJA GOL G5 L-D / NBJ1011D NAKATA', 0, '5.00', '5.00', NULL, NULL, '', '2021-03-18 22:45:38', 0, 8),
...
(569, '7891342008105    ', 770413, 'FILTRO DE OLEO - WO200', 0, '5.00', '5.00', 1, NULL, '', '2021-03-18 22:45:38', 0, 8),
(570, '7891342005296    ', 770387, 'FILTRO DE OLEO / GI60/7', 0, '5.00', '5.00', 1, NULL, '', '2021-03-18 22:45:38', 0, 8),
(571, '7891342016414    ', 770006, 'FILTRO DE OLEO / PSL55', 0, '5.00', '5.00', 1, NULL, '', '2021-03-18 22:45:38', 0, 8),
...
(1000, '7893272004141    ', 771462, 'TAMPA RESERVATORIA AGUA FOX GOL / TC-3062 CLICK', 1, '5.00', '5.00', 1, 0, './imgs/dfmm.jpg', '2021-03-18 22:45:38', 7, 8),
...
(1, 'Alinhamento veiculo', '50'),
(2, 'Balanciamento', '40'),
(3, 'Limpeza de bico', '100'),
(4, 'Alinhamento Pickup', '60'),
(5, 'Servicos mecânico', '160');
...
ALTER TABLE `clientes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_cliente_veiculo1_idx` (`veiculo_id`),
...
--
ALTER TABLE `clientes`
  ADD CONSTRAINT `fk_cliente_veiculo1` FOREIGN KEY (`veiculo_id`) REFERENCES `veiculos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
