...
<!-- <body class="hold-transition dark-mode sidebar-closed sidebar-collapse"> -->
<!-- sidebar-mini layout-fixed -->

<body class="hold-transition sidebar-closed sidebar-collapse dark-mode layout-fixed layout-navbar-fixed layout-footer-fixed">
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-dark ">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="cliente-list.php" class="nav-link">Clientes</a>
      </li>
