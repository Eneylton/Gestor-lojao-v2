                         ...
                         <form method="post">
                              <div class="card card-danger">
                                   <div class="card-header ">
                                        <h3 class="card-title">Formulário de edição de clientes...</h3>
                                   ...
                                   <div class="form-group">
                                             ...
                                             <div class="form-group">
                                                  <label>Placa</label>
                                                  <input type="text" class="form-control" name="placa" value="<?= $cliente->placa ?>">
                                             </div>

                                      
                                        <div class="form-group">
                                                  <label>Veículo</label>
                                                  <select class="form-control form-control-lg" name="veiculo_id" value="<?= $cliente->veiculo_id ?>" required>
