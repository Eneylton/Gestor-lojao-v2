...
foreach ($listar as $item) {
   ...
   $resultados .= '<tr>
                      ...
                      <td style="text-transform:uppercase">' . $item->email . '</td>
                      <td style="text-transform:uppercase">' . $item->placa . '</td>
                      <td style="text-transform:uppercase">' . $item->veiculo . '</td>
                      <td style="text-align: center;">
                        
                       <a href="cliente-edit.php?id=' . $item->id . '">
            ...
            <div class="card card-danger">
                  ...
                  <form method="get">
                     <div class="row my-7">
                        <div class="col">
                           ...
                           <label>Buscar por nome do Nome /email / telefone / placa</label>
               ...
               <div class="card-body">
                  ...
                  <div class="col d-flex align-items-end">
                     ...
                     <a href="cliente-insert.php">
                        <button type="submit" class="btn btn-success"> <i class="fas fa-plus"></i> Adicionar Novo cliente</button>
                     </a>
